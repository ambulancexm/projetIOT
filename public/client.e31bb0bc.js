...
},{"process":"../../node_modules/process/browser.js"}],"pubsub.js":[function(require,module,exports) {
"use strict";
...
var events = {}; // subscribe to an event

var on = function on(eventName, fn) {
...
var off = function off(eventName, fn) {
  _.remove(events[eventName], function (f) {
    return fn === f;
  });
}; // emit an event
...
exports.emit = emit;
},{}],"iotDevices.js":[function(require,module,exports) {
"use strict";
...
var addSelectedSensor = function addSelectedSensor(sensor) {
  return _lodash.default.findIndex(state.selectedSensors, function (s) {
    return s.name === sensor.name && s.device === sensor.device;
  }) === -1 && state.selectedSensors.push(sensor);
}; // cache DOM
...
var IOTDevicesTemplate = function IOTDevicesTemplate(IOTDevicesData) {
  var devicesTemplateArr = _lodash.default.map(IOTDevicesData, function (IOTDeviceData, device) {
    var sensorTemplateArr = _lodash.default.map(_lodash.default.last(IOTDeviceData.data).sensors, function (sensor) {
      return sensorTemplate(sensor.name, sensor.val, device);
    });
...
var render = function render(IOTDevicesData) {
  return $iotDevices.html(IOTDevicesTemplate(IOTDevicesData));
}; // attach events
// sensor button click


$iotDevices.delegate('.btn-sensor ', 'click', function (e) {
  var _e$currentTarget$id$s = e.currentTarget.id.split('-'),
      _e$currentTarget$id$s2 = _slicedToArray(_e$currentTarget$id$s, 2),
      device = _e$currentTarget$id$s2[0],
      name = _e$currentTarget$id$s2[1];
...
(0, _pubsub.on)('server/data/update', function (data) {
  return render(data.IOTDevice);
});
},{"lodash":"../../node_modules/lodash/lodash.js","jquery":"../../node_modules/jquery/dist/jquery.js","./pubsub":"pubsub.js"}],"constante.js":[function(require,module,exports) {
"use strict";
...
var constante = _interopRequireWildcard(require("./constante"));
...
//************* write data ****************
var ws = new WebSocket("ws://localhost:" + constante.port); //ouverture webSocket
...
ws.onmessage = function (event) {
  ...
  (0, _pubsub.emit)('server/data/update', data);
};
},{"bootstrap/dist/css/bootstrap.css":"../../node_modules/bootstrap/dist/css/bootstrap.css","./iotDevices":"iotDevices.js","./constante":"constante.js","./pubsub":"pubsub.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
